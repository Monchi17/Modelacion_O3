...
def mostrar_bienvenida():
    st.markdown("<h1 style='text-align: center;'>Visualizador de Planos</h1>", unsafe_allow_html=True)
    st.markdown("### Por favor, ingresa tu información antes de continuar:")
    nombre = st.text_input("Nombre completo")
    profesion = st.text_input("Profesión")
    experiencia = st.number_input("Años de experiencia", min_value=0, max_value=100, step=1)
...
if st.session_state.pagina == 'bienvenida':
    ...
    # ...código actual de visualización de planos...
    # ...existing code...
